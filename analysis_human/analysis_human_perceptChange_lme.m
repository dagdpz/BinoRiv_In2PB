...
function analysis_human_perceptChange_lme()
...
%                 end
    ...
    preprocessedData_switchEffect(table_count_switchEffect,:) = struct('Individual', data_dir_task1(subj).name, 'SubjectID', subj_num,...
        'Task', 1, 'WithSaccade', 1, 'WithFPj', 1, 'PCT_binoriv', binoriv_timing_task1, 'PCT_binoriv_median', median(binoriv_timing_task1),...
        'PCT_phys', phys_timing_task1, 'PCT_phys_median', median(phys_timing_task1)); % PCT: Percept Changed Timing
    table_count_switchEffect = table_count_switchEffect + 1;
    preprocessedData_switchEffect(table_count_switchEffect,:) = struct('Individual', data_dir_task1(subj).name, 'SubjectID', subj_num,...
        'Task', 2, 'WithSaccade', 0, 'WithFPj', 0, 'PCT_binoriv', binoriv_timing_task2, 'PCT_binoriv_median', median(binoriv_timing_task2),...
        'PCT_phys', phys_timing_task2, 'PCT_phys_median', median(phys_timing_task2));
    ...
    table_count_FPjEffect = table_count_FPjEffect + 1;
    preprocessedData_FPjEffect(table_count_FPjEffect,:) = struct('Individual', data_dir_task1(subj).name, 'SubjectID', subj_num,...
        'Task', 3, 'WithSaccade', 0, 'WithFPj', 1, 'PCT_binoriv', binoriv_timing_task3, 'PCT_binoriv_median', median(binoriv_timing_task3),...
        'PCT_phys', phys_timing_task3, 'PCT_phys_median', median(phys_timing_task3));
    ...
    table_count_SacEffect = table_count_SacEffect + 1;
    preprocessedData_SacEffect(table_count_SacEffect,:) = struct('Individual', data_dir_task1(subj).name, 'SubjectID', subj_num,...
        'Task', 4, 'WithSaccade', 1, 'WithFPj', 0, 'PCT_binoriv', binoriv_timing_task4, 'PCT_binoriv_median', median(binoriv_timing_task4),...
        'PCT_phys', phys_timing_task4, 'PCT_phys_median', median(phys_timing_task4));
...
preprocessedData_switchEffect_table.PCT_binoriv_median = double(preprocessedData_switchEffect_table.PCT_binoriv_median);
...
preprocessedData_FPjEffect_table.PCT_binoriv_median = double(preprocessedData_FPjEffect_table.PCT_binoriv_median);
...
preprocessedData_SacEffect_table.PCT_binoriv_median = double(preprocessedData_SacEffect_table.PCT_binoriv_median);
...
preprocessedData_interaction_table.PCT_binoriv_median = double(preprocessedData_interaction_table.PCT_binoriv_median);
...
lme_switchEffect = fitlme(preprocessedData_switchEffect_table, 'PCT_binoriv_median ~ Task + (1|SubjectID)');
disp(lme_switchEffect);
randomEffects(lme_switchEffect)

% FPj effect
lme_FPjEffect = fitlme(preprocessedData_FPjEffect_table, 'PCT_binoriv_median ~ Task + (1|SubjectID)');
disp(lme_FPjEffect);
randomEffects(lme_FPjEffect)

% Saccade effect
lme_SacEffect = fitlme(preprocessedData_SacEffect_table, 'PCT_binoriv_median ~ Task + (1|SubjectID)');
disp(lme_SacEffect);
randomEffects(lme_SacEffect)

% Saccade+FPj effect
lme_interaction = fitlme(preprocessedData_interaction_table, 'PCT_binoriv_median ~ WithSaccade*WithFPj + (1|SubjectID)');
