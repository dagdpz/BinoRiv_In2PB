...
switch Current_con.timing_con
    case 0 % 'calibration'
        ...
        task.timing.fix_time_to_acquire_eye     = 2; % from acquiring the eye to the hold state
        task.timing.tar_time_to_acquire_eye     = 1;
        task.timing.tar_inv_time_to_acquire_eye = 1;
        task.timing.fix_time_hold               = 3; % Duration the subject has to fixate
...
task.eye.fix.color_dim          = [0 0 0];%[0 0 128]; %
task.eye.fix.color_bright       = [0 0 0];%[0 0 128];
