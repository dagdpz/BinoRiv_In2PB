...
%         end
    ...
    case 'Bacchus'
        ...
        %%% monkey setup
%         task.custom_conditions      = 'D:\Sources\MATLAB\monkeypsych_IN2PB\conditions\combined_condition_file_calib'; % calibration
%         task.custom_conditions      = 'D:\Sources\MATLAB\monkeypsych_IN2PB\conditions\Bacchus/combined_condition_file_continuous_binoriv'; % continuous binocular rivalry task 

        %%% human setup for test
        task.custom_conditions      = 'D:\monkeypsych\conditions\Bacchus\combined_condition_file_calib'; % calibration
%         task.custom_conditions      = 'D:\monkeypsych\conditions\Bacchus\combined_condition_file_training'; % training
%         task.custom_conditions      = 'D:\monkeypsych\conditions\Bacchus\combined_condition_file_continuous_binoriv'; % continuous binocular rivalry task 
