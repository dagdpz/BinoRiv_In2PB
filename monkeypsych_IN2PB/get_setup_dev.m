...
switch SETTINGS.setup,
    ...
    case -1 % "DAG psychophysics BinoRiv"
        ...
        SETTINGS.screen_w_cm = 59.6;
        SETTINGS.screen_h_cm = 33.7;
        SETTINGS.ai = 0;
        SETTINGS.ao = 0;
        SETTINGS.use_digital_to_TDT = 0;
        SETTINGS.check_motion_jaw = 0;
        ...
        SETTINGS.BG_COLOR = [186 186 186];
        
        % I/O
        SETTINGS.AI_channels                            = [0 2 4 6]; % touch_x touch_y jaw_motion body_motion
        SETTINGS.Motion_detection_interface             = 'DAQ';%'Parallel'; % e.g. MD
%         SETTINGS.GUI_coordinates                        = [-1500 300 1700 1700*SETTINGS.screen_h_pix/SETTINGS.screen_w_pix];
        SETTINGS.GUI_coordinates                        = [-1500 300 1200 1100]; % [hoge hoge width height]
