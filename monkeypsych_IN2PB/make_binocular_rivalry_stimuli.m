...
function make_binocular_rivalry_stimuli()
...
% mkdir(OutputFolder)
mkdir('BinoRiv_stimuli/with_fp')
mkdir('BinoRiv_stimuli/with_2fp')
% mkdir('In2PB/BinoRiv')
% mkdir('In2PB/Phys')
...
dist_scr = 47; % viewing distance (cm)
screen_width = 59.6; % human setup: 59.6, monkey setup 1: 59.5
screen_height = 33.7; % human setup: 33.7, monkey setup 1: 33.3
...
showFixPointRectangleRed = true;
showFixPointRed = true;
showFixPointRectangleCyan = true;
showFixPointCyan = true;
...
%                     OutputImage_obj(:,:,3) = OutputImageCyanOrientationFilter;
                    ...
                    mkdir(['BinoRiv_stimuli/with_fp/RedContour_' num2str(RedImageContour) '_RedFP_' num2str(RedImageFixPointContrast) ...
                    ...
                    OutputFolder = ['BinoRiv_stimuli/with_fp/RedContour_' num2str(RedImageContour) '_RedFP_' num2str(RedImageFixPointContrast) '_BlueContour_' num2str(CyanImageContour) '_BlueFP_' num2str(CyanImageFixPointContrast) '/Face_' num2str(RedImageContrast) '_Object_' num2str(CyanImageContrast)];
...
% 
% % centre (side/2, side/2), rad side/2 �?�円内�?�グリッド点を示�?�インデックスを作�?
